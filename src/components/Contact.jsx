...
// ------------------ Custom styles variables  ------------------ //
  ...
  const form_container_styles = `flex px-[20px] py-[20px] rounded-lg transition-all ease-in-out duration-500 ${ darkMode ? "shadow-[3px_3px_10px_#000000a2]" : "shadow-[3px_3px_10px_#12121276]" }`;
...
// ------------------ Custom styles variables  ------------------ //
 ...
 const handleSubmit = async (e) => {
  ...
  return (
    <section id="contact" className={` ${margins_paddings} flex flex-row-reverse items-center lg:items-start justify-between max-lg:flex-col max-lg:gap-[40px] max-md:py-[70px] py-[100px] w-full gap-[50px]`}> 
        {/* Form */}
        <div className="flex flex-col gap-[30px] justify-start max-lg:w-full max-w-[600px] lg:w-[55%]">
                        {/* this text is lg screens only */}
          <div className={`lg:hidden text-[1.3rem] items-start max-sm:items-center flex ${textColor} flex-col`}>
          ...
          <div id="form-container" className={`${form_container_styles} w-full`} >
          
            <form onSubmit={handleSubmit} className="space-y-[17px] w-full transition-all ease-in-out duration-500">
      ...
      <div id="PC" className=" gap-[20px] flex max-lg:w-full max-w-[700px] lg:w-[60%] flex-col justify-start max-lg:hidden w-[30%]" >
         {/* Text Above */}
         <div className={`text-[1.3rem] items-start max-sm:items-center flex ${textColor} flex-col`}>
          <h1 className={`text-wrap max-sm:text-center`}>Interested in collaborating or learning more about my projects?</h1>
        ...
        <img src={`${darkMode? 'PCMULTI.gif':'/bluePC.gif'}`} className="w-full max-w-[500px]" alt="" />
      </div>
