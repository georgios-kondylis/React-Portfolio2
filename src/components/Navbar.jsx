    ...
    <div className={`${NavbarStyles} `}>
      <div id="NAVBAR" className={`max-sm:px-[20px] max-lg:px-[40px] lg:px-[100px] flex w-full max-w-[1540px] gap-[20px] items-center justify-between transition-all ease-in-out duration-700`}>
        ...
        <div className={`w-[250px]`}>
          ...
          : <div></div>}
          {/* NAVLINKS */}
        <div className={`${textColor} text-[1.2rem] max-lg:text-[1rem] flex items-center gap-4 max-lg:gap-[15px] max-lg:hidden transition-all ease-out duration-300`}> {/* Navlinks */}
        ...
        {/* -------  sideNav  ------- */}
        <div className={`px-[5px] fixed top-0 left-0 ${!sideNavIsOpen ? 'right-[100%] opacity-0 pointer-events-none' :  'right-[60%] max-w-[250px]' } bottom-0 ${darkMode? 'bg-[#121212]' : 'bg-[#eee4d9]'}  z-50 transition-all ease-in-out duration-300 border-r border-r-[#5c5c5c49]
